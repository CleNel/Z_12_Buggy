...
int speed_control(double inp2){
  if (pidOutput > 0) {
    speed = map(inp2, 0, 255, 0, 255); // increase the speed of the motor
  } 
  else if (pidOutput < 0) {
    speed = map(inp2, -255, 0, -255, 0); // decrease the speed of the motor
  }
}
